  ...
  return (
    <motion.div 
      ...
      className="p-1 text-center lg:w-3/4" id="contact">
        ...
        <button className="border m-4 rounded bg-transparent border-stone-50/30 px-3 py-1 hover:bg-purple-950"><a href="mailto:dhavaleankush3@gmail.com">Say Hello</a></button>
    </motion.div>
  )
}
